// see if you want to print the upper triangular matrix then condition is j>=i
// see if you want to print the strict upper triangular matrix then condition is j>i
// and if you want to print the lower triangular matrix then condition is i>=j
